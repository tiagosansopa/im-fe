export default function Location() {
  return (
    ...
    >
      ...
      <div className="relative max-w-screen-lg mx-auto space-y-12">
        <div className="width-full  text-white text-center">
          <h2 className="text-2xl font-bold  uppercase mb-8">VISITANOS</h2>
        </div>
