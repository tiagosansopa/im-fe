  ...
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto">
        <h2 className="text-2xl font-bold uppercase mb-8">Nuestros Valores</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col items-center h-[300px] w-[200px] mx-auto">
            ...
            <p className="mt-2 text-sm leading-relaxed text-center">
              Siempre en busca de productos que cumplan con los requerimientos
              del mercado y cumpliendo con una exhaustiva búsqueda de
